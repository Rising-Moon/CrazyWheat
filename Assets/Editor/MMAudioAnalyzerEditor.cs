...
namespace MoreMountains.Tools
{
    ...
    public class MMAudioAnalyzerEditor : Editor
    {
        ...
        protected Color _normalBarColor = new Color(1f, 0.65f, 0.08f);
        protected Color _normalNormalizedBarColor = Color.cyan;
        protected Color _peakColor = Color.yellow;
        protected Color _activePeakColor = Color.white;
        protected Color _amplitudeColor = new Color(0.64f, 0.25f, 0.01f);
        protected Color _normalizedAmplitudeColor = new Color(0f, 0.16f, 0.64f);
        protected Color _spectrumColor = new Color(0.64f, 0.01f, 0.27f);
        ...
        protected virtual void DrawBandVisualization()
        {
            ...
            GUILayout.Box("", GUILayout.Width(_inspectorWidth - _externalMargin),
                GUILayout.Height(_bandsValuesBoxHeight));
            ...
            if ((BandPeaks != null) && (BandPeaks.arraySize == _numberOfBands))
            {
                for (int i = 0; i < _numberOfBands; i++)
                {
                    ...
                    _axisOrigin.y = _boxBottomY - peak * _maxColumnHeight;
            ...
            // amplitude cursors
            _columnHeight = Amplitude.floatValue * _maxColumnHeight;
            ...
            _columnHeight = BufferedAmplitude.floatValue * _maxColumnHeight;
            ...
            for (int i = 0; i < _numberOfBands; i++)
            {
                if (Active)
                {
                    ...
                    _columnHeight = bandLevel * _maxColumnHeight;
        ...
        protected virtual void DrawBandVisualizationNormalized()
        {
            ...
            // amplitude cursors
            _columnHeight = NormalizedAmplitude.floatValue * _maxColumnHeight;
            _positionX = _boxPosition.x - _externalMargin / 4;
            _positionY = _boxBottomY - _columnHeight;
            ...
            _columnHeight = NormalizedBufferedAmplitude.floatValue * _maxColumnHeight;
            _positionX = _boxPosition.x + _boxSize.x - _externalMargin / 4;
            _positionY = _boxBottomY - _columnHeight;
        ...
        protected virtual void DrawRawSpectrum()
        {
            ...
            if (Active)
            {
                ...
                {
                    float xPosition = _spectrumBoxPosition.x + _externalMargin + (float)i /
                        RawSpectrum.arraySize * (_spectrumBoxSize.x - _externalMargin * 2);
            ...
            else
            {
                ...
                {
                    float xPosition = _spectrumBoxPosition.x + _externalMargin +
                                      (float)i / points * (_spectrumBoxSize.x - _externalMargin * 2);
                    float yPosition = _spectrumBoxPosition.y + _spectrumBoxSize.y / 2;
